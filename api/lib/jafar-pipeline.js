...
FABRICATED URLS: If you do not have a real URL from retrieved_quotes for a passage, write the fragment in plain quotation marks — NEVER in [text](anything) format. Do not invent URLs. Do NOT write the literal word "url" in parentheses.
ABSOLUTELY BANNED (never appear in Q-entries, do not exist in this system): "siftersearch.com/library/..." — this URL format does not exist. WRONG: "[text](https://siftersearch.com/library/Judaism/Talmud/...)".
VALID when from a Q-entry: "siftersearch.com/document/{id}" URLs DO exist and ARE valid — IF AND ONLY IF they appear in a Q-entry's citation_url field. Never fabricate one from memory. If Q3's citation_url is "https://siftersearch.com/document/12345", then "[fragment](https://siftersearch.com/document/12345)" is correct.
RIGHT: "text" (plain, unlinked) when no citation_url exists in the Q-entry.
