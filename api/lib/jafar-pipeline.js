...
- CITATION URL RULE: each fragment's link URL MUST be the citation_url of the specific retrieved_quotes entry the fragment came from. Do NOT swap URLs between entries. If Q3's text says "love your enemies" and Q3's citation_url is "https://oceanlibrary.com/some-gospel", then the link must be "[love your enemies](https://oceanlibrary.com/some-gospel)" — not the URL from Q5 or any other entry. The citation_url is provided in each Q-entry below — use the EXACT URL from that entry.
