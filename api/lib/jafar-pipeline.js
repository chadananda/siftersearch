...
URL RULE SUMMARY: Use citation_url from the Q-entry exactly as given. If no citation_url → plain text quote. Never invent URLs. Never use siftersearch.com/library/... (doesn't exist).
