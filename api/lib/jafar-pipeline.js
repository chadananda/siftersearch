...
- Browsing questions with a catalog answer ("what's the largest collection?", "do you have Jain texts?") → (1) call library_overview to get catalog data; (2) ALSO call search with the relevant religion/collection filter to retrieve 1-2 representative passages. Catalog answers without quotes score low.
