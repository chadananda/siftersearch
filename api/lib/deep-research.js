...
const VISUAL_THEMES = [
  ...
  { keys: ['ethics','conduct','virtue','morality','character'],
  ...
  { keys: ['science','reason','science-reason','knowledge','truth'],
  ...
  { keys: ['law','practice','ritual','law-practice','observance','fasting'],
  ...
  { keys: ['creation','nature','cosmos','genesis','universe'],
  ...
  { keys: ['sin','redemption','sin-redemption','transformation'],
  ...
  { keys: ['service','humanitarian','charity','sacrifice'],
  ...
  { keys: ['time','calendar','seasons','holy days','sacred time'],
