...
DO NOT extract: a bare name in a list or pure co-occurrence with NO information ("accompanied by Quddús", "Dr. and Mrs. Getsinger"), or trivial movement of no significance. If a passage only names the person without conveying any fact, relationship, connection, or characterization, SKIP it. Quote EXACTLY from the passage.
