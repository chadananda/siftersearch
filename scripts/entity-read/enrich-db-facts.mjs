...
Extract the SIGNIFICANT facts: defining deeds and events they led or shaped, their role in the upheavals (Shaykh Ṭabarsí, Zanján, Nayríz, Badasht…), key relationships and conversions, titles conferred on them, and their FATE (how/where they died or were martyred). Give the shortest exact verbatim span that states each fact.
