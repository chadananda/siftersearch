...
NISBAS AND PLACES ARE SOFT EVIDENCE, NOT KEYS — do NOT split on a place/nisba difference alone: the SAME person may be named by different nisbas (a village vs its province, e.g. Ishtihárdí and Qazvíní are one man), a PROVINCE CONTAINS ITS CITIES so "governor of Fars" and "governor of Shíráz" are one office / one man, nisbas are often absent, and TWO different people can share one town. Weigh place only alongside era/role/fate. Places merely visited or associates' origins are never contradictions — only the person's OWN incompatible life-facts. When the evidence is genuinely one coherent life, answer coherent even if names/nisbas vary.
