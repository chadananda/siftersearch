...
- There is NO inherited Western-style family-name SYSTEM. A person is a COMPOSITE: honorific(s) + given name + nisba (place of origin, "-i-<Place>") and/or conferred title(s). BUT fixed bynames DO act as distinguishing surnames — "Mírzá Aḥmad", "Áqáy-i-Kalím" function as a person's surname/identifier. And because a nisba is shared by EVERYONE from a town (broad, not unique), people are very often distinguished by TITLE, BYNAME, or OFFICIAL POSITION rather than nisba alone.
- Titles carry rank/role: Mírzá BEFORE the name = court nobility/educated, but Mírzá AFTER the name = PRINCE (royal descent); Mullá = scholar; Mujtahid = a leading, credentialed scholar (senior to a mullá); Siyyid = descendant of the Prophet; Shaykh, Áqá. Plus many place-specific OFFICIAL POSITIONS that themselves identify a person: Imám-Jum‘ih (leader of Friday prayer of a given city), Shaykhu'l-Islám, Sulṭánu'l-‘Ulamá, etc.
- POSITION of Ḥájí / Mashhadí / Karbilá'í matters: BEFORE the name they are pilgrimage titles (Ḥájí = pilgrim to Mecca, Mashhadí to Mashhad, Karbilá'í to Karbilá); written AFTER as a suffix ("-i-Karbilá'í") they are a nisba (of/from that place).
...
- The GIVEN NAME alone barely identifies anyone — Muḥammad, Ḥasan, Ḥusayn, ‘Alí are shared by dozens. The NISBA (village/region), usually given at first introduction ("Mullá Ḥusayn-i-Bushrú'í" = Mullá Ḥusayn FROM Bushrúyih), narrows the field but is itself BROAD — everyone from that town shares it — so combine it with title, byname, official position, side, and context to pin a person down.
