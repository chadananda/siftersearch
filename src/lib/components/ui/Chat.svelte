...
<div class="h-full flex flex-col bg-surface">
        ...
        {#if message.speaker === 'user'}
          <div class="relative mb-6 mr-5">
            <div class="flex justify-end">
              <div class="bg-[var(--user-message-bg)] text-[var(--user-message-text)] p-4 rounded-2xl rounded-br-none max-w-[80%] sm:max-w-[70%] text-lg whitespace-pre-wrap">
                {message.message}
              </div>
            </div>
          </div>
  ...
  <div class="flex-none bg-surface-2 border-t border-subtle-light shadow-app-sm relative z-10">
