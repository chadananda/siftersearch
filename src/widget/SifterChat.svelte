  ...
  <div class="root {cfg.position === 'bottom-left' ? 'left' : 'right'}" style="--accent:{cfg.accent}">
    {#if open}
      <section class="panel" bind:this={panelEl} aria-label="{cfg.name} chat">
        ...
        <div class="brand"><a href="https://siftersearch.com" target="_blank" rel="noopener">SifterSearch</a></div>
      </section>
    {/if}
...
<style>
  ...
  * { box-sizing: border-box; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; }
  ...
  .bubble { max-width: 88%; padding: 9px 12px; border-radius: 12px; font-size: 14px; line-height: 1.45; white-space: pre-wrap; word-break: break-word; }
