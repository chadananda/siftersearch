    ...
    {#if activeTab === 'sites'}
      ...
      <div class="bg-surface-2 rounded-lg p-4 mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <label for="frequency-filter" class="block text-sm font-medium mb-1">Crawl Frequency</label>
            <select
              id="frequency-filter"
          ...
          <div>
            <label for="tags-filter" class="block text-sm font-medium mb-1">Tags</label>
            <input
              id="tags-filter"
              type="text"
              ...
              <div class="flex-1 p-6">
                <div class="flex justify-between items-start">
                  ...
                  <div class="flex gap-2">
                    ...
                    <button
                      onclick={() => handleCrawlNow(site.id)}
                      class="p-2 text-text-secondary hover:text-text-primary rounded-lg hover:bg-surface-3"
                      aria-label="Crawl site now"
                    >
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
