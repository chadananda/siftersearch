    ...
    <div class="mt-4 space-y-4">
      ...
      <div class="flex flex-wrap gap-4 bg-surface-2 p-4 rounded-lg">
        ...
        <div class="flex-1 min-w-[200px]">
          <label for="collectionsFilter" class="block text-sm font-medium mb-1">Collections</label>
          <select
        ...
        <!-- Types Filter -->
        <div class="flex-1 min-w-[200px]">
          <label for="typesFilter" class="block text-sm font-medium mb-1">Types</label>
          <select
            id="typesFilter"
            multiple
        ...
        <!-- Quality Filter -->
        <div class="flex-1 min-w-[200px]">
          <label for="qualityFilter" class="block text-sm font-medium mb-1">Minimum Quality</label>
          <input
            id="qualityFilter"
            type="range"
