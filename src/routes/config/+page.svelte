      ...
      <div class="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
              <div class="space-y-2">
                <label for="libraryId" class="block text-sm font-medium">Library ID</label>
                <input
                  id="libraryId"
                  type="text"
        ...
        <Card>
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                <label for="defaultLanguage" class="block text-sm font-medium">Default Language</label>
                <select
                  id="defaultLanguage"
              ...
              <div class="space-y-2">
                <label for="maxResults" class="block text-sm font-medium">Max Results</label>
                <input
                  id="maxResults"
                  type="number"
              ...
              <div class="space-y-2">
                <label for="vectorWeight" class="block text-sm font-medium">Vector Weight</label>
                <input
                  id="vectorWeight"
                  type="range"
              ...
              <div class="space-y-2">
                <label for="bm25Weight" class="block text-sm font-medium">BM25 Weight</label>
                <input
                  id="bm25Weight"
                  type="range"
        ...
        <Card>
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
              <div class="space-y-2">
                <label for="allowedTypes" class="block text-sm font-medium">Allowed Content Types</label>
              ...
              <div class="space-y-2">
                <label for="defaultLicense" class="block text-sm font-medium">Default License</label>
                <select
                  id="defaultLicense"
              ...
              <div class="space-y-2">
                <label for="customMetadataFields" class="block text-sm font-medium">Custom Metadata Fields</label>
                <div class="space-y-3">
                  {#each config.content.customMetadataFields as field}
                    <div class="flex items-center gap-3 bg-surface-2 p-3 rounded-lg">
                      ...
                      <button 
                        ...
                        aria-label="Delete metadata field"
                      >
        ...
        <Card>
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                <label for="defaultDirection" class="block text-sm font-medium">Default Direction</label>
                <select
                  id="defaultDirection"
              ...
              <div class="col-span-2">
                <label for="enabledLanguages" class="block text-sm font-medium mb-2">Enabled Languages</label>
        ...
        <Card>
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
              <div class="space-y-2">
                <label for="botName" class="block text-sm font-medium">Bot Name</label>
                <input
                  id="botName"
                  type="text"
              ...
              <div class="space-y-2">
                <label for="defaultPrompt" class="block text-sm font-medium">Default Prompt</label>
                <textarea
                  id="defaultPrompt"
