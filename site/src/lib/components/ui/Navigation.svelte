<script>
  const navigation = [
    ...
    { name: 'Libraries', href: '/libraries', icon: 'M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z' },
  ...
  let currentPath = '/';
  $: activeItem = navigation.find(item => item.href === currentPath);
</script>

<nav class="bg-surface text-text-primary border-b border-subtle">
      ...
      <div class="flex">
        ...
        <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
          {#each navigation as item}
            <a
              href={item.href}
              class="text-lg inline-flex items-center px-1 pt-1 text-text-secondary hover:text-text-primary"
